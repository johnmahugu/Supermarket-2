...
--
-- Host: localhost
-- Generation Time: Apr 14, 2017 at 04:14 PM
...
(16, 'tour cover', 13, 'filestorage/image/tour/13.jpg');
...
--
ALTER TABLE `client`
  MODIFY `client_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=254;
--
...
--
ALTER TABLE `tour_address`
  MODIFY `ta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
