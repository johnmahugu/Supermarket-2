		...
		<main>
			<div class="title-bar-wrapper">
				<div class="main-wrapper">
					<div class="row">
						<div class="col-xs-12">
							<h1>New Promotion Package</h1>
							<p>Nok Air Packages</p><br>
						</div>
						<div class="col-sm-6 col-xs-12">
							<input type="text" placeholder="Thai Package Name">
						</div>	
						<div class="col-sm-6 col-xs-12">
							<input type="text" placeholder="English Package Name">
						</div>					
					</div>
					...
					<div class="row top-mg">
						...
						<div class="col-sm-4 col-xs-12 label-level text-center">
				...
				<div class="row">
					<div class="card-btn-tab">
						<div class="col-sm-6 no-pd">
							<a href="tm-mc-promotion-pkg-new.html" class="btn current">TOUR INFO</a>
						</div>
						<div class="col-sm-6 no-pd">
							<a href="tm-mc-promotion-pkg-new-condition.html" class="btn no-setting">CONDITION</a>
						</div>
					</div>
				</div>
				<div class="row">
