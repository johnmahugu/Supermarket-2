			...
			<div class="title-bar-wrapper">
				<div class="main-wrapper">
					...
					<div class="row top-mg">
						<div class="col-sm-4">
							<label class="filter">Origin City</label><br>
							<form method="get" action="st-flightAll">
							<select onchange="this.form.submit()" name="city">
								<option>All City</option>
								<?php
								foreach ($TicketCity as $value2) {
						...
						<div class="col-md-2 col-md-push-6 col-sm-3 col-sm-push-5 col-xs-12">
							<a href="st-airline" class="btn border label-level">
								View Airline List  <i class="fa fa-angle-right" aria-hidden="true"></i>
							</a>
						</div>

						<div class="col-md-6 col-md-pull-2 col-sm-5 col-sm-pull-3 col-xs-12">
							<div class="btn no-border gray label-level">
				...
				<div class="row">
					...
					<div class="list-card">
						...
						<div class="input-inline">
							<div class="digi-box">
								<p><?php echo $this->AdminMD->countFlight($ctid) ?>&nbsp;Flights</p>
							</div>
							<div class="input-box btn-inline">
								<a href="st-delTicketCity?cityid=<?php echo $ctid ; ?>" class="btn gray hide">Delete</a>
								<a href="st-flightAll?originid=<?php echo $ctid ; ?>" class="btn border">View <i class="fa fa-angle-right" aria-hidden="true"></i></a>
							</div>
						</div>
					</div>
				<?php
	    ...
	    <div class="modal-dialog modal-md">
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
				...
				<form method="post" action="st-addCityTicket">
				<select name="city">
