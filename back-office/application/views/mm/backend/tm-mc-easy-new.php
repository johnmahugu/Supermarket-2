				...
				<div class="row">
					<div class="card-btn-tab">
						<div class="col-sm-4 no-pd">
							<a href="tm-mc-easy-new.html" class="btn current">TOUR INFO</a>
						</div>
						<div class="col-sm-4 no-pd">
							<a href="tm-mc-easy-new-service.html" class="btn no-setting">SERVICES</a>
						</div>
						<div class="col-sm-4 no-pd">
							<a href="tm-mc-easy-new-condition.html" class="btn no-setting">CONDITION</a>
						</div>
					</div>
				</div>
				<div class="row">
