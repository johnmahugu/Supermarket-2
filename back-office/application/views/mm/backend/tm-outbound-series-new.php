				...
				<div class="row">
					<div class="card-btn-tab">
						<div class="col-sm-6 no-pd">
							<a href="tm-outbound-series-new.html" class="btn current">TOUR INFO</a>
						</div>
						<div class="col-sm-6 no-pd">
							<a href="tm-outbound-series-new-condition.html" class="btn no-setting">CONDITION</a>
						</div>
					</div>
				</div>
				<div class="row">
