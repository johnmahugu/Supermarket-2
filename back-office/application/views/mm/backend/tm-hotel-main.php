				...
				<div class="main-wrapper">
					...
					<div class="row top-mg">
						<div class="col-sm-4">
							...
							<form method="get" action="HotelAll">
							<select onchange="this.form.submit()" name="city">
							<option> All City </option>
							<?php
								foreach ($HotelCity as $value2) {
				...
				<div class="row">
					...
					<div class="list-card">
						...
						<div class="input-inline">
							<div class="digi-box">
								<p><?php echo $this->AdminMD->countHotel($ctid) ?>&nbsp;Hotels</p>
							</div>
							<div class="input-box btn-inline">
								<a href="st-delHotelCity?cityid=<?php echo $ctid ; ?>" class="btn gray hide">Delete</a>
								<a href="st-hotelAll?city=<?php echo $ctid ; ?>" class="btn border">View <i class="fa fa-angle-right" aria-hidden="true"></i></a></form>
							</div>
						</div>
					</div>
	    ...
	    <div class="modal-dialog modal-md">
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
				...
				<form method="post" action="st-addCityHotel">
				<select name="city">
