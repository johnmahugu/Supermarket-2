				...
				<div class="main-wrapper">
					...
					<div class="row top-mg">
						<div class="col-sm-4">
							...
							<form method="get" action="OtherAll">
							<select onchange="this.form.submit()" name="cityid">
								<option>All City</option>
								<?php
								foreach ($OtherCity as $value2) {
				...
				<div class="row">
					...
					<div class="list-card">
						...
						<div class="input-inline">
							<div class="digi-box">
								<p><?php echo $this->model->countOther($ctid) ?>&nbsp;Items</p>
							</div>
							<div class="input-box btn-inline">
								<a href="DelOtherCity?cityid=<?php echo $ctid ; ?>" class="btn gray hide">Delete</a>
								<?php /////ON WORK ///?>
								<a href="OtherAll?cityid=<?php echo $ctid ; ?>" class="btn border">View <i class="fa fa-angle-right" aria-hidden="true"></i></a></form>
							</div>
						</div>
					</div>
	    ...
	    <div class="modal-dialog modal-md">
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
				<label class="filter">City</label><br>
				<form method="post" action="addCityOther">
				<select name="city">
