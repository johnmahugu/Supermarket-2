...
$totaltourist = $b_detail['tourist'][0]['totaltourist'];
				...
				<div class="form-group">
					...
					<div id="noaccount">
						...
						<hr>
							...
							<span>Your Email</span>  is a Username and <span>Your Tel No.</span> is a Password for login to Your Account. <a href="_signin?from=sbi">Or Your have a account</a></p>
						</div>
					</div>
				</div>
				<?php
