        ...
        <div class="row profile">
          <div class="col-xs-12">
            <h1><span>Edit Profile</span>
              <?=$session['client_firstName']." ".$session['client_middleName']." ".$session['client_lastName']?>
            </h1>
          </div>
        </div>
      </div>
              ...
              <div>
                ...
                <div class="col-md-12">
                  ...
                  <p class="note"><i class="fa fa-thumb-tack" aria-hidden="true"></i>
                    If you change your<span> telephonum number.</span> it will change your password accordingly.
                  </p>
                </div>
              </div>
            </form>
