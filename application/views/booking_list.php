		...
		<div class="container">
			...
			<div class="row profile">
				<div class="col-xs-12">
					...
					<?php echo $session['client_firstName']." ".$session['client_middleName']." ".$session['client_lastName']?></h1>
				...
				<div class="mybooking-card">
					...
					<div class="col-sm-3 col-lg-2">
						...
						<div class="btn-wrapper">
							<div class="btn link cancel-booking" cancel-booking="<?php echo $row['booking_code']?>" data-toggle="modal" data-target="#cancel">Cancel</div><br>
